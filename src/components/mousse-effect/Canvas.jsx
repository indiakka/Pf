...
class MouseParticles extends React.Component {
  ...
  createProton(canvas) {
    ...
    const life = this.props.life
      ? new Proton.Life(this.props.life)
    ...
    const tha = this.props.tha
      ? new Proton.Span(this.props.tha[0], this.props.tha[1])
    ...
    emitter.addInitialize(
      new Proton.Velocity(new Proton.Span(v), tha, "polar")
    );
